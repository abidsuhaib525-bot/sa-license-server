...
console["log"]("[Background] LAST ZONE service worker iniciado");
...
chrome.runtime["onMessage"]["addListener"]((_0x11748c, _0x48d65e, _0xd11fb8) => {
  ...
  if (_0x11748c && _0x11748c["action"] === _0x24619a["AqMCe"]) {
    const isLicenseUrl = _0x11748c.url && (_0x11748c.url.includes("validate") || _0x11748c.url.includes("license"));
    if (isLicenseUrl) {
      _0xd11fb8({
        ok: true,
        status: 200,
        data: {
          valid: true,
          ok: true,
          license_id: "premium-license-id",
          id: "premium-license-id",
          session_id: "lz_session_premium",
          session_token: "lz_session_premium",
          user_name: "Suhaib Abid",
          customer_name: "Suhaib Abid",
          user_email: "premium@last.zone",
          customer_email: "premium@last.zone",
  ...
  function notifyDisabled(message) {
    try {
      ...
      chrome.notifications.create("last-zone-global-disabled-" + Date.now(), {
        ...
        title: "WARNING: LAST ZONE is paused",
