...
(function () {
  ...
  var REPLACEMENTS = [[/Developed\s+by\s+Lovable\s+Hut\s+BD\s+Extension/gi, FOOTER_TEXT], [/Developed\s+by\s+Lovable\s+Hut\s+BD\s+Store/gi, FOOTER_TEXT], [/Developed\s+by\s+Lovable\s+Hut\s+BD/g, FOOTER_TEXT], [/Developed\s+by\s+LAST\s+ZONE/g, FOOTER_TEXT], [/Lovable\s+Hut\s+BD\s+Extension/g, BRAND_NAME], [/Lovable\s+Hut\s+Bd\s+Extension/g, BRAND_NAME], [/LAST\s+ZONE\s+Extension/g, BRAND_NAME], [/Lovable\s+Hut\s+BD/g, BRAND_NAME], [/Lovable\s+Hut\s+Bd/g, BRAND_NAME], [/Ornov\s+Tech\s+BD/g, BRAND_NAME], [/Infinity\s+Lovable/g, BRAND_NAME], [/Lovable\s+Infinity/g, BRAND_NAME], [/Por:\s*LAST\s+ZONE/g, FOOTER_TEXT], [/Por:\s*@dynhosilvaoficial/g, FOOTER_TEXT], [/@dynhosilvaoficial/g, BRAND_NAME], [/INFINITY-XXXX-XXXX-XXXX/g, LICENSE_PLACEHOLDER], [/Checking\s+license\s+on\s+LAST\s+ZONE\s+server\.\.\./g, "Checking license on LAST ZONE..."]];
