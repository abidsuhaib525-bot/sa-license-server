(function() {
  function showBanner(type, message, stack) {
    ...
    item.innerHTML = `<strong>[LAST ZONE ${type}]</strong>: ${message}<pre style="margin:5px 0 0 0;font-size:11px;color:#f87171;white-space:pre-wrap;word-break:break-all;">${stack || ""}</pre>`;
...
var _I18N = {
  ...
  en: {
    ...
    "expired.renew": "WHATSAPP-+8801618125458",
    "expired.close": "Close",
  ...
  he: {
    ...
    "btn.publish": "WHATSAPP-+8801618125458",
    "btn.cloud": "☁️ הפעל ענן Lovable",
    "footer.support": "תמיכה",
    "footer.brand": "פותח על ידי LAST ZONE",
    "notif.title": "התראות",
    "notif.loading": "טוען...",
