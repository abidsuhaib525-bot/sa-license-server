...
(function () {
  ...
  function renderDisabled() {
    ...
    var title = text("Suhaib Abid is paused", "تم إيقاف Suhaib Abid مؤقتاً");
    ...
    overlay.innerHTML = "<div class=\"lz-disable-card\"><img class=\"lz-disable-logo\" src=\"" + chrome.runtime.getURL("assets/logo-master-lovable-square.png") + "\" alt=\"Suhaib Abid\"><div class=\"lz-warning-triangle\">!</div><h2>" + title + "</h2><p>" + desc + "</p><div class=\"lz-disable-note\">" + note + "</div><a href=\"" + SUPPORT_URL + "\" target=\"_blank\" rel=\"noopener noreferrer\">" + support + "</a></div>";
  }
    ...
    window.fetch = function (input, init) {
      ...
      if (state.disabled && sourceUrl.indexOf(SUPABASE_URL) === 0 && (sourceUrl.indexOf("/rest/v1/licenses") !== -1 || sourceUrl.indexOf("/functions/v1/") !== -1)) {
        ...
        return Promise.resolve(new Response(JSON.stringify({
          valid: false,
          ok: false,
          message: "Suhaib Abid is paused by admin.",
          error: "Suhaib Abid is paused by admin."
        }), {
          status: 200,
          headers: {
